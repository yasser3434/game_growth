...
def_reg.write.mode("overwrite").parquet(CURATED + "reg_data/")
...
df_auth.write.mode("overwrite").parquet(CURATED + "auth_data/")
...
df_ab.write.mode("overwrite").parquet(CURATED + "ab_test/")
